$(function () {
        ...
        series : [
            {
                name:'入会数量',
                type:'line',
                data:[112, 115, 155, 134, 129, 134, 108],
                markPoint : {
                    data : [
                        {type : 'max', name: '最高'},
                        {type : 'min', name: '最低'}
    ...
    var baroption = {
        ...
        xAxis : [
            {
                type : 'category',
                data : ['太原市','大同市','朔州市','忻州市','阳泉市','晋中市','吕梁市','临汾市','长治市','运城市','晋城市']
            }
        ],
        yAxis : [
            {
        ...
        series : [
            {
                name:'建会成功',
                type:'bar',
                data:[78, 42, 63, 32, 23, 36, 55, 42, 25, 36, 51],
                markPoint : {
                    data : [
                        {type : 'max', name: '最多'},
                        {type : 'min', name: '最低'}
            ...
            },
            {
                name:'建会申请',
                type:'bar',
                data:[89, 56, 75, 42, 36, 96, 45, 65, 48, 65, 62],
                markPoint : {
                    data : [
                       {type : 'max', name: '最多'},
                        {type : 'min', name: '最低'}
    ...
    var pieoption = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['20-30岁','31-35岁','35-40岁','40-50岁','50岁以上']
        },
        calculable : true,
        series : [
            {
                ...
                center: ['50%', '60%'],
                data:[
                    {value:335212, name:'20-30岁'},
                    {value:310334, name:'31-35岁'},
                    {value:234674, name:'35-40岁'},
                    {value:135124, name:'40-50岁'},
                    {value:154846, name:'50岁以上'}
                ]
            }
        ]
    };
                ...
                data : [
                    {
                     ...
                     {
                        value : [2500, 8400, 12800, 31000, 42000, 21000],
                        name : '女性'
                    }
                ]
            }
