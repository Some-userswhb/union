    ...
    var handleRecords = function () {
        ...
        var tbs=$('.dataTables-example').dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: baseUrl+"/passLaborweb/api/laborun/organization/queryPage",
                    cache: false,  //禁用缓存
...
//                            console.log(selectThis);
            ...
            columns: [
                ...
                {
                    "render": function () {
                        return ' <button type="button" class="btn  btn-primary">编辑</button> <button type="button" class="btn  btn-primary">删除 </button>';
                    },
                    "bSortable": false
                },
            ]
